  ...
  return (
    ...
    >
      ...
      {isVisible && (
        <div
          ref={tooltipRef}
          className={`absolute z-50 px-3 py-2 text-sm text-white bg-gray-900 dark:bg-gray-800 rounded-lg shadow-xl whitespace-nowrap backdrop-blur-sm border border-gray-700 dark:border-gray-600 pointer-events-none ${getPositionClasses()} animate-fadeIn`}
          role="tooltip"
        >
          {content}
          <div
