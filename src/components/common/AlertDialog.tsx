    ...
    switch (type) {
      case 'success':
        return {
          ...
          button: 'bg-emerald-600 hover:bg-emerald-700 focus-visible:outline-emerald-500 text-white'
        };
      case 'error':
        return {
          icon: (
          ...
          button: 'bg-rose-600 hover:bg-rose-700 focus-visible:outline-rose-500 text-white'
        };
      case 'warning':
        return {
          icon: (
          ...
          button: 'bg-amber-500 hover:bg-amber-600 focus-visible:outline-amber-500 text-white'
        };
      case 'info':
        return {
          icon: (
          ...
          button: 'bg-sky-600 hover:bg-sky-700 focus-visible:outline-sky-500 text-white'
        };
      default:
        return {
          icon: null,
  ...
  return (
    <ModalFrame
      ...
      footer={
        <button
          onClick={onClose}
          className={`inline-flex items-center justify-center rounded-xl px-4 py-2.5 text-sm font-medium transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 ${typeStyles.button}`}
        >
          {buttonText}
        </button>
      }
