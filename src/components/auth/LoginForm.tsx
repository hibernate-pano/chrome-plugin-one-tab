...
export const LoginForm: React.FC<LoginFormProps> = ({ onSuccess }) => {
  ...
  return (
    <div className="max-w-md mx-auto">
      ...
      <form onSubmit={handleSubmit} className="rounded-xl border border-gray-200/80 bg-white/95 p-6 shadow-md backdrop-blur-sm dark:border-gray-700/80 dark:bg-gray-900/90">
        <div className="mb-5">
