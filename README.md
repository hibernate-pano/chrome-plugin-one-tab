# OneTab Plus - Chrome标签管理器 (v1.5.11)

这是一个Chrome浏览器扩展程序，用于高效管理和组织浏览器标签页。现已发布稳定的 1.5.11 版本。
...
- [清理重复标签](./docs/clean-duplicate-tabs.md)
